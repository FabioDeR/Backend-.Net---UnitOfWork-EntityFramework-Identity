...
namespace eLearn360.API.Controllers.BaseController
{
    ...
    public class CourseController : ControllerBase
    {
        ...
        public CourseController(IUnitOfWork unitOfWork, IHttpContextAccessor httpContextAccessor)
        {
        ...
        public async Task<IActionResult> Post([FromBody] Course course)
        {
            try
            {
                ...
                else
                {
                    ...
                    {
                        course.ImageUrl = $"https://{currentUrl}/api/Images/ImageByDefault/95f98557-de39-45e7-9319-2a3dc088f8c2-defaultImg.png";
                    }
