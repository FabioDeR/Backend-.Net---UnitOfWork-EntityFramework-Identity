...
namespace eLearn360.API.Migrations
{
    ...
    [Migration("20220908093720_InitialV1")]
            ...
            modelBuilder.Entity("eLearn360.Data.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("d18f1ca1-a6d0-46a8-a506-6d3d62c690e0"),
                        ...
                        new
                        {
                            Id = new Guid("12da606e-48e0-4fec-95c7-4ad733c99e1a"),
                            CreationTrackingUserId = new Guid("00000000-0000-0000-0000-000000000000"),
                            DeleteTrackingUserId = new Guid("00000000-0000-0000-0000-000000000000"),
                            Name = "Autre",
                            UpdateTrackingUserId = new Guid("00000000-0000-0000-0000-000000000000")
            ...
            modelBuilder.Entity("eLearn360.Data.Models.Gender", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("dcfbe993-acfc-414f-b404-e01438033be1"),
                            Abbreviated = "Mme.",
                            CreationTrackingUserId = new Guid("00000000-0000-0000-0000-000000000000"),
                            DeleteTrackingUserId = new Guid("00000000-0000-0000-0000-000000000000"),
                            Name = "Femme",
                        ...
                        new
                        {
                            Id = new Guid("e786249d-47ed-4c56-b8a0-2e81ae432677"),
                            Abbreviated = "M.",
                            CreationTrackingUserId = new Guid("00000000-0000-0000-0000-000000000000"),
                            DeleteTrackingUserId = new Guid("00000000-0000-0000-0000-000000000000"),
                            Name = "Homme",
                        ...
                        new
                        {
                            Id = new Guid("2e85c8f3-07dc-4025-a513-525ee12eb595"),
                            Abbreviated = "X.",
                            CreationTrackingUserId = new Guid("00000000-0000-0000-0000-000000000000"),
                            DeleteTrackingUserId = new Guid("00000000-0000-0000-0000-000000000000"),
                            Name = "Autre",
            ...
            modelBuilder.Entity("eLearn360.Data.Models.Group", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("4576e12a-3b3b-4e18-b76a-c6719779918c"),
                            CreationTrackingUserId = new Guid("00000000-0000-0000-0000-000000000000"),
                            DeleteTrackingUserId = new Guid("00000000-0000-0000-0000-000000000000"),
                            Name = "Public",
                            OrganizationId = new Guid("24086603-1913-42a8-b276-08fe612bebdd"),
                            UpdateTrackingUserId = new Guid("00000000-0000-0000-0000-000000000000")
                        });
                });
            ...
            modelBuilder.Entity("eLearn360.Data.Models.Level", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("ab502ebb-44a7-42d1-88b4-a48a89633d45"),
                            CreationTrackingUserId = new Guid("00000000-0000-0000-0000-000000000000"),
                            DeleteTrackingUserId = new Guid("00000000-0000-0000-0000-000000000000"),
                            Name = "Novice",
                            UpdateTrackingUserId = new Guid("00000000-0000-0000-0000-000000000000")
                        ...
                        new
                        {
                            Id = new Guid("607cc016-9cd7-41d5-872a-9a0d84d7312a"),
                            CreationTrackingUserId = new Guid("00000000-0000-0000-0000-000000000000"),
                            DeleteTrackingUserId = new Guid("00000000-0000-0000-0000-000000000000"),
                            Name = "Confirmé",
                            UpdateTrackingUserId = new Guid("00000000-0000-0000-0000-000000000000")
                        ...
                        new
                        {
                            Id = new Guid("8931abf8-9c1b-4376-9300-1f07c6e1afee"),
                            CreationTrackingUserId = new Guid("00000000-0000-0000-0000-000000000000"),
                            DeleteTrackingUserId = new Guid("00000000-0000-0000-0000-000000000000"),
                            Name = "Expert",
                            UpdateTrackingUserId = new Guid("00000000-0000-0000-0000-000000000000")
            ...
            modelBuilder.Entity("eLearn360.Data.Models.Occupation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("3bbee11a-fb1d-4f7c-9c94-f4e4823734f8"),
                            ConcurrencyStamp = "5b158a72-7b64-4257-aad8-ce6f8477ea01",
                            CreationTrackingUserId = new Guid("00000000-0000-0000-0000-000000000000"),
                            DeleteTrackingUserId = new Guid("00000000-0000-0000-0000-000000000000"),
                        ...
                        new
                        {
                            Id = new Guid("7f6a01b2-031f-4d86-a93b-44b6ec7005a9"),
                            ConcurrencyStamp = "16625f76-a312-4058-9b4a-6635baae789a",
                            CreationTrackingUserId = new Guid("00000000-0000-0000-0000-000000000000"),
                            DeleteTrackingUserId = new Guid("00000000-0000-0000-0000-000000000000"),
                        ...
                        new
                        {
                            Id = new Guid("f46cc0f9-66e4-4da6-ba21-5ba27c4a1bba"),
                            ConcurrencyStamp = "7e7bb63d-1fa1-4acf-8081-8fbd6837b307",
                            CreationTrackingUserId = new Guid("00000000-0000-0000-0000-000000000000"),
                            DeleteTrackingUserId = new Guid("00000000-0000-0000-0000-000000000000"),
                        ...
                        new
                        {
                            Id = new Guid("7a588313-5761-4f21-a443-e8c623e769f0"),
                            ConcurrencyStamp = "e02103c4-53f6-4db5-940f-603b653eb623",
                            CreationTrackingUserId = new Guid("00000000-0000-0000-0000-000000000000"),
                            DeleteTrackingUserId = new Guid("00000000-0000-0000-0000-000000000000"),
                        ...
                        new
                        {
                            Id = new Guid("7d9e35cc-9efb-45d7-b51c-3ef1c3901f59"),
                            ConcurrencyStamp = "6425d3b6-79b9-4dcd-b755-18974c5d84a9",
                            CreationTrackingUserId = new Guid("00000000-0000-0000-0000-000000000000"),
                            DeleteTrackingUserId = new Guid("00000000-0000-0000-0000-000000000000"),
                        ...
                        new
                        {
                            Id = new Guid("a00be780-4c80-4336-bafb-b1df6a8e9783"),
                            ConcurrencyStamp = "485ee6c3-83c0-4251-8775-dd41d16977e0",
                            CreationTrackingUserId = new Guid("00000000-0000-0000-0000-000000000000"),
                            DeleteTrackingUserId = new Guid("00000000-0000-0000-0000-000000000000"),
            ...
            modelBuilder.Entity("eLearn360.Data.Models.Organization", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("24086603-1913-42a8-b276-08fe612bebdd"),
            ...
            modelBuilder.Entity("eLearn360.Data.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("a8a02d6a-68b2-47e3-9e90-60b475f33364"),
                            AccessFailedCount = 0,
                            Address = "Rue de Virginal 40",
                            Birthday = new DateTime(2022, 9, 8, 11, 37, 19, 935, DateTimeKind.Local).AddTicks(9981),
                            City = "Virginal",
                            ConcurrencyStamp = "e186463d-5e90-4174-b04f-8ee1240f6bf8",
                            Country = "Be",
                            CreationDate = new DateTime(2022, 9, 8, 11, 37, 19, 936, DateTimeKind.Local).AddTicks(19),
                            CreationTrackingUserId = new Guid("00000000-0000-0000-0000-000000000000"),
                            DeleteTrackingUserId = new Guid("00000000-0000-0000-0000-000000000000"),
                            Email = "kjouret@educassist.be",
                            EmailConfirmed = true,
                            FirstName = "Kevin",
                            GenderId = new Guid("e786249d-47ed-4c56-b8a0-2e81ae432677"),
                            LastName = "Jouret",
                            LockoutEnabled = true,
            ...
            modelBuilder.Entity("eLearn360.Data.Models.UserHasGroup", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("ef207285-66c2-4a83-b3a3-bb4fe6239806"),
                            CreationTrackingUserId = new Guid("00000000-0000-0000-0000-000000000000"),
                            DeleteTrackingUserId = new Guid("00000000-0000-0000-0000-000000000000"),
                            EndDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            GroupId = new Guid("4576e12a-3b3b-4e18-b76a-c6719779918c"),
                            IsHeadTeacher = false,
                            StartDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            UpdateTrackingUserId = new Guid("00000000-0000-0000-0000-000000000000"),
                            UserId = new Guid("a8a02d6a-68b2-47e3-9e90-60b475f33364")
                        });
                });
            ...
            modelBuilder.Entity("eLearn360.Data.Models.UserHasOccupation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("120cef07-29b4-42ae-9230-ded508db8d26"),
                            CreationTrackingUserId = new Guid("00000000-0000-0000-0000-000000000000"),
                            DeleteTrackingUserId = new Guid("00000000-0000-0000-0000-000000000000"),
                            OccupationId = new Guid("3bbee11a-fb1d-4f7c-9c94-f4e4823734f8"),
                            OrganizationId = new Guid("24086603-1913-42a8-b276-08fe612bebdd"),
                            UpdateTrackingUserId = new Guid("00000000-0000-0000-0000-000000000000"),
                            UserId = new Guid("a8a02d6a-68b2-47e3-9e90-60b475f33364")
                        });
