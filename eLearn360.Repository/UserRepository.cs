    ...
    public class UserRepository : Repository<Guid, User>, IUserRepository
    {
        ...
        public async Task<List<Claim>> CreateClaimsByUser(User user)
        {
            try
            {
                ...
                var userFind = await _entities.Where(u => u.Id == user.Id)
                ...
                var groupOrgAndOccup = userFind.UserHasOccupations.Where(d => d.DeleteDate == null)
                                                                  .Select(u => new
                                                                  {
                                                                      OrganizationId = u.OrganizationId,
                                                                      OrganizationName = u.Organization.Name,
                                                                      OrganizationImg = u.Organization.ImageUrl,
                                                                      OccupationList = userFind.UserHasOccupations.Where(d => d.DeleteDate == null && d.OrganizationId == u.OrganizationId).Select(o => o.Occupation.Name).Distinct().ToList()
        ...
        public async Task<List<Organization>> GetAllOrganizationByUserId(Guid userid)
        {
            try
            {
                List<Organization> organizations = await _entities.Where(u => u.Id == userid)
                                                                  .Include(o => o.UserHasOccupations)
                                                                  .ThenInclude(o => o.Organization)
                                                                  .SelectMany(o => o.UserHasOccupations)
                                                                  .Where(o => o.DeleteDate == null && o.Organization.DeleteDate == null)
