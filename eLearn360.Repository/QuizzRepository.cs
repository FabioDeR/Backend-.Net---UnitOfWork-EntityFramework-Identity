    ...
    public class QuizzRepository : Repository<Guid, Quizz>, IQuizzRepository
    {
        ...
        public async Task<QuizzVM> QuizzGeneration(QuizzVM quizzVM)
        {
            try
            {
                ...
                questions = GetPropabilities((int)quizzVM.TypeEnum, quizzVM.nbQuestion, questionLessons, questionSections, questionCourses, questionPaths);
                questions = ShuffleList(questions);
                quizz.Questions = new();
                quizz.Questions = questions;
                quizzVM = TransformToVM(quizz, quizzVM);
        ...
        public List<Question> GetPropabilities(int type, int nbQuestion, List<Question> questionLessons, List<Question> questionSections, List<Question> questionCourses, List<Question> questionPaths)
        {
            try
            {
                ...
                switch (type)
                {
                    case 1:
                        ...
                        if (dictioProbality["Lesson"] <= 1)
                        {
                            ...
                            questionLessons = GetRandomQuestion(questionLessons, nbQuestionLesson);
                        }
                        break;
                    ...
                    case 2:
                        ...
                        if (dictioProbality["Section"] <= 0.7)
                        {
                            ...
                            questionSections = GetRandomQuestion(questionSections, nbQuestionSection);
                    ...
                    case 3:
                        ...
                        if (dictioProbality["Course"] <= 0.5)
                        {
                            ...
                            questionCourses = GetRandomQuestion(questionCourses, nbQuestionCourse);
                    ...
                    case 4:
                        ...
                        if (dictioProbality["Path"] <= 0.4)
                        {
                            ...
                            questionPaths = GetRandomQuestion(questionPaths, nbQuestionPath);
                        }
        ...
        public List<Question> GetRandomQuestion(List<Question> questions, int nbQuestion)
        {
            try
            {
        ...
        #region Shuffle List
        public List<Question> ShuffleList(List<Question> questions)
        {
            var rnd = new Random();
            List<Question> listRnd = questions.OrderBy(item => rnd.Next()).ToList();
            return listRnd;
        ...
        public QuizzVM TransformToVM(Quizz quizz, QuizzVM quizzVM)
        {
            try
            {
