    ...
    public class OrganizationRepository : Repository<Guid, Organization>, IOrganizationRepository
    {
        ...
        public async Task<Organization> GetAllUserByOrganizationId(Guid organizationId)
        {
            try
            {
                ...
                Organization organization = await _entities.Where(o => o.Id == organizationId && o.UserHasOccupations.Any(d => d.DeleteDate == null))
                    ...
                    .Select(o => new Organization()
                    {
                        ...
                        Website = o.Website,
                        ZipCode = o.ZipCode,
                        Users = o.UserHasOccupations.Where(u => u.DeleteDate == null).Select(u => u.User).Distinct().Select(u => new User()
                        {
                            Id = u.Id,
